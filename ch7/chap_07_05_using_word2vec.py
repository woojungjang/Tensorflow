...
# 함수 
###################################################################################################
# text_helpers 파일을 이용하여 데이터를 로딩하고, 문서를 변환해준다.
print('Loading Data')
...
dict_file = os.path.join('movie_vocab.pkl')
dict_file = os.path.join( '..', '07_Natural_Language_Processing', 'temp', 'movie_vocab.pkl')

# word_dictionary = pickle.load(open('movie_vocab.pkl', 'rb'))
